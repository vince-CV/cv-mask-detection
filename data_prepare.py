...
# Absolute path of output .txt files
f_val = open("C:/Users/xwen2/Google Drive/Mask Detector/data_test_rp1.txt", 'w')
f_train = open("C:/Users/xwen2/Google Drive/Mask Detector/data_train_rp1.txt", 'w')
