...
image_path = "C:/Users/xwen2/Google Drive/Mask Detector/data_rp1/"
anota_path = "C:/Users/xwen2/Google Drive/Mask Detector/data_rp1/"
save_path = "C:/Users/xwen2/Desktop/3/"
...
for image_name in imagelist:
    ...
    if (extention != ".txt"): 
        ...
        for i in range(aug):
            ...
            np.savetxt(save_path+nameWithoutExtention+"_aug"+str(i)+".txt", yolo_aug, fmt='%6e')

            cv.imwrite(save_path+nameWithoutExtention+"_aug"+str(i)+".JPG", images_aug[0])
        #print(bbs_aug[0])
